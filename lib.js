...
// @todo: RecipeList object should be inserted in a closure or in a class in a different file.
...
//// variable declarations
    ...
    // The process combines in one object all the ingredients of the flow
...
//              for (let hop of boil.hops)
    ...
    // shortcut function to "brew" a full flow in one shot
    this.brew = function () {
    ...
    // splits a given flow in two by dropping volume from its current
    // volume and returning a new flow object with volumne of wort added
    ...
    // merges a given wort into the current flow
...
/// flow management functions
    ...
    // returns a flow object to work with
    // @fixme: the RecipeList object can be directly exported and used with the keywoard new.
    newRecipe : function () {
        return new Recipe();
    }
